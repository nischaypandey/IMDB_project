...
//MainActivity class which is extending AppCompatActivity class
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //setting layout to MainActivity class
        ...
        rvAdapter = new RVAdapter(initialList,MainActivity.this);
        ...
        option1.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(final View view)
            {
                ...
                PopupMenu popup = new PopupMenu(MainActivity.this, option1);
                        ...
                        switch (id)
                        {
                            case R.id.most_popular:
                                ...
                                if(isIntenetConnected())
                                {
                                    ...
                                    MovieList movieList=new MovieList(MainActivity.this,movieurl);
                                }
                                else
                                {
                            ...
                            case R.id.latest_movies:
                                ...
                                if(isIntenetConnected())
                                {
                                    ...
                                    LatestMovies latestMovies = new LatestMovies(MainActivity.this,movieurl);
                                }
                                else
                                {
                                    //displaying toast message
        ...
        option2.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                //Creating the instance of PopupMenu
                PopupMenu popup = new PopupMenu(MainActivity.this, option2);
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem)
                    {
                        ...
                        switch (id)
                        {
                            case R.id.my_favoriates:
                                ...
                                Intent intent = new Intent(MainActivity.this,MyFavoriateScreen.class);
                            ...
                            case R.id.my_watchlist:
                                ...
                                Intent intent1 = new Intent(MainActivity.this,MyWatchlistScreen.class);
    ...
    public class MovieList implements HandleJsonListener,ItemClicked
    {
        ...
        public MovieList(Context context, String URL)
        {
            ...
            NetworkRequestTask networkRequestTask = new NetworkRequestTask(MainActivity.this,movieurl,this);
        ...
        public void updateData(String json)
        {
            ...
            RVAdapter rvAdapter = new RVAdapter(initialList,MainActivity.this);
        ...
        public void onCLick(View view, int position)
        {
            ...
            Intent intent = new Intent(MainActivity.this,MovieDetailScreen.class);
    ...
    //LatestMovies class which is implementing HandleJsonListener & ItemClicked listener
