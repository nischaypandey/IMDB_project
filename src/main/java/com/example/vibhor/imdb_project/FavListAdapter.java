...
/**
 * Created by Nischay on 18-01-2018.
 */
...
public class FavListAdapter extends RecyclerView.Adapter<FavListAdapter.VersionViewHolder>
{
    ...
    ArrayList<StoringData> versionList;
    ...
    //constructor
    public FavListAdapter(ArrayList<StoringData> versionList, Context mContext)
    {
    ...
    public void onBindViewHolder(FavListAdapter.VersionViewHolder holder, int position)
    {
        ...
        //setting image to posterName
        /*
        Glide.with(mContext).load("http://image.tmdb.org/t/p/w500"+versionList.get(position).getStoredimage())
    ...
    public class VersionViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public VersionViewHolder(View itemView)
        {
            ...
            posterName=itemView.findViewById(R.id.list_image);
