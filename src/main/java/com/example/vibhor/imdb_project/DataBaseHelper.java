...
public class DataBaseHelper extends SQLiteOpenHelper
{
    ...
    public void addFavEntry( StoringData storingData) throws SQLiteException
    {
    ...
    public void addWatchEntry( StoringData storingData) throws SQLiteException
    {
        //creating instance of SQLiteDatabase class
        SQLiteDatabase database = this.getWritableDatabase();
    ...
    public ArrayList<StoringData> getAllFavMovie()
    {
        //creating arraylist to get the stored favmovielist
        ArrayList<StoringData> list = new ArrayList<>();
    ...
    public ArrayList<StoringData> getAllWatchMovie()
    {
